...
public class OptionsTest
{
    ...
    @Test
    public void testCurvePublicKeyNull()
    {
        options.setSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY, null);
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY), nullValue());
    }
    ...
    @Test
    public void testCurveSecretKeyNull()
    {
        options.setSocketOpt(ZMQ.ZMQ_CURVE_SECRETKEY, null);
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_SECRETKEY), nullValue());
    }
    ...
    @Test
    public void testCurveServerKeyNull()
    {
        options.setSocketOpt(ZMQ.ZMQ_CURVE_SERVERKEY, null);
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_SERVERKEY), nullValue());
    }

    @Test
    public void testCurvePublicKeyCopy()
    {
        byte[] key = new byte[32];
        Arrays.fill(key, (byte) 11);
        options.setSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY, key);
        byte[] option = (byte[]) options.getSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY);
        option[0] = 0;
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY), is(key));
    }

    @Test
    public void testCurveSecretKeyCopy()
    {
        byte[] key = new byte[32];
        Arrays.fill(key, (byte) 12);
        options.setSocketOpt(ZMQ.ZMQ_CURVE_SECRETKEY, key);
    ...
    @Test
    public void testCurveServerKeyCopy()
    {
        byte[] key = new byte[32];
        Arrays.fill(key, (byte) 14);
        options.setSocketOpt(ZMQ.ZMQ_CURVE_SERVERKEY, key);
    ...
    @Test
    public void testHeartbeatContext()
    {
        byte[] key = new byte[32];
        Arrays.fill(key, (byte) 42);
        options.setSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT, key);
        assertThat(options.getSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT), is(key));
    }

    @Test
    public void testHeartbeatContextCopy()
    {
        byte[] key = new byte[32];
        Arrays.fill(key, (byte) 42);
        options.setSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT, key);
        byte[] option = (byte[]) options.getSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT);
        option[0] = 0;
        assertThat(options.getSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT), is(key));
    }
    ...
    public void testDefaultValue()
    {
        ...
        assertThat(options.getSocketOpt(ZMQ.ZMQ_HEARTBEAT_CONTEXT), is(new byte[0]));
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_SERVERKEY), is(new byte[32]));
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_SECRETKEY), is(new byte[32]));
        assertThat(options.getSocketOpt(ZMQ.ZMQ_CURVE_PUBLICKEY), is(new byte[32]));
    }
}
