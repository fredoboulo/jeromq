...
public class PubSubHwmTest
{
    ...
    public void testRepeated()
    {
        for (int idx = 0; idx < 10_000; ++idx) {
            ...
            testSubscriptionsHwmInproc();
            testSubscriptionsHwmTcp();
        }
    }
    ...
    {
        int subscriptions = 30_000;
        assertHwmSubscription(subscriptions, 999, subscriptions - 1, "tcp://*:*");
    }

    @Test
    public void testSubscriptionsHwmInproc()
    {
        assertHwmSubscription(30_000, 2000, 30_000 - 1, "inproc://pubsub");
    }

    private void assertHwmSubscription(int allSubscriptions, int subscribed, int subscriptionNotSent, String endpoint)
    {
        Ctx ctx = ZMQ.createContext();
