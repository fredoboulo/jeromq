...
import org.zeromq.poll.ZTimer.Timer;
...
public class ZTimerTest
{
    ...
    {
        boolean rc = timers.cancel(new ZTimer.Timer(0, null));
    ...
    {
        boolean rc = timers.setInterval(new ZTimer.Timer(0, null), 10);
        assertThat(rc, is(false));
    }
    ...
    {
        boolean rc = timers.reset(new ZTimer.Timer(0, null));
        assertThat(rc, is(false));
    }
    ...
    {
        Timer timer = timers.add(10, new ZTimer.Handler()
        {
            @Override
            public void time(Object... args)
            {
    ...
    private int sleepAndExecute(ZTimer timer)
    {
